...
\COPY GroupResponse(post_id, g_id, section_id, time_posted, message) FROM 'data/GroupResponse.dat' WITH DELIMITER ',' NULL '' CSV
\COPY UserResponse(post_id, u_id, section_id, time_posted, message) FROM 'data/UserResponse.dat' WITH DELIMITER ',' NULL '' CSV
